...
def zip1 (promedio,velocidad_1,distancia_1):
    ...
    c3 = 0
    c4 = 0
    velocidad_bajo_promedio_distancia_sobre_promedio =[]
    ...
    print(f" velocidades bajo al promedio :{(list(filter(lambda x: x < velocidad_promedio, velocidad_1)))} \n")
    print(f"1 Cantidad de  velocidades bajo al total :{len((list(filter(lambda x: x[0] < velocidad_promedio, velocidad_distancia))))} \n")
